                    ...
                    <ul>
                        ...
                        <li><a href="">Pages</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="./check-out.html">Thanh Toán Đơn Hàng</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="checkout-content">
                            <a href="./login.html" class="content-btn">Nhấn vào đấy để đăng nhập</a>
                        </div>
                        <h4>Chi tiết thanh toán</h4>
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="fir">Tên <span>*</span></label>
                                <input type="text" name="" id="fir">
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" name="" id="cun">
                            </div>
                            <div class="col-lg-12">
                                <label for="street">Địa chỉ <span>*</span></label>
                                <input type="text" name="" id="street" class="street-first">
                        ...
                        <div class="place-order">
                            ...
                            <div class="order-total">
                                <ul class="order-table">
                                    ...
                                    <li class="fw-nomal">Kết hợp x 1 <span>$60.00</span></li>
                                    <li class="fw-nomal">Kết hợp x 1 <span>$60.00</span></li>
                                    <li class="fw-nomal">Kết hợp x 1 <span>$60.00</span></li>
                                    <li class="fw-nomal">Tổng phụ <span>$240.00</span></li>
                                    <li class="total-price">Tổng <span>$240.00</span></li>
                                </ul>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="./img/footer-logo.png" height="25" alt="footerlogo">
                            </a>
                        </div>
                        <ul>
