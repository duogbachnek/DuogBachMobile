...
<head>
    ...
    <title>DuogBachDev | Template</title>
                ...
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select name="countries" id="countries" class="language_drop" style="width: 300px;">
                            <option data-image="img/flag-1.jpg" data-imagecss="flag yt" data-title="English" value="yt">
                                English</option>
                            <option data-image="img/flag-2.jpg" data-imagecss="flag yu" data-title="German" value="yu">
                                German</option>
                        </select>
                    </div>
